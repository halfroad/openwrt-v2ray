...
GO_PKG:=github.com/v2fly/v2ray-core
GO_PKG_LDFLAGS:=-s -w
GO_PKG_LDFLAGS_X:= \
	github.com/v2fly/v2ray-core.version=$(PKG_VERSION) \
	github.com/v2fly/v2ray-core.build=R$(PKG_RELEASE) \
	github.com/v2fly/v2ray-core.codename=OpenWrt
...
V2RAY_SED_ARGS += \
	s,// \(_ "github.com/v2fly/v2ray-core/main/json"\),\1,; \
	s,_ "github.com/v2fly/v2ray-core/main/jsonem",// &,;
...
V2RAY_SED_ARGS += \
	s,_ "github.com/v2fly/v2ray-core/app/dns",// &,; \
	s,_ "github.com/v2fly/v2ray-core/app/dns/fakedns",// &,;
...
V2RAY_SED_ARGS += \
	s,_ "github.com/v2fly/v2ray-core/app/log",// &,; \
	s,_ "github.com/v2fly/v2ray-core/app/log/command",// &,;
endif

ifeq ($(CONFIG_PACKAGE_v2ray_$(BUILD_VARIANT)_without_tls),y)
V2RAY_SED_ARGS += \
	s,_ "github.com/v2fly/v2ray-core/transport/internet/tls",// &,;
endif

ifeq ($(CONFIG_PACKAGE_v2ray_$(BUILD_VARIANT)_without_udp),y)
V2RAY_SED_ARGS += \
	s,_ "github.com/v2fly/v2ray-core/transport/internet/udp",// &,;
endif

ifeq ($(CONFIG_PACKAGE_v2ray_$(BUILD_VARIANT)_without_policy),y)
V2RAY_SED_ARGS += \
	s,_ "github.com/v2fly/v2ray-core/app/policy",// &,;
endif

ifeq ($(CONFIG_PACKAGE_v2ray_$(BUILD_VARIANT)_without_reverse),y)
V2RAY_SED_ARGS += \
	s,_ "github.com/v2fly/v2ray-core/app/reverse",// &,;
endif

ifeq ($(CONFIG_PACKAGE_v2ray_$(BUILD_VARIANT)_without_routing),y)
V2RAY_SED_ARGS += \
	s,_ "github.com/v2fly/v2ray-core/app/router",// &,;
endif

ifeq ($(CONFIG_PACKAGE_v2ray_$(BUILD_VARIANT)_without_statistics),y)
V2RAY_SED_ARGS += \
	s,_ "github.com/v2fly/v2ray-core/app/stats",// &,; \
	s,_ "github.com/v2fly/v2ray-core/app/stats/command",// &,;
endif

ifeq ($(CONFIG_PACKAGE_v2ray_$(BUILD_VARIANT)_without_blackhole_proto),y)
V2RAY_SED_ARGS += \
	s,_ "github.com/v2fly/v2ray-core/proxy/blackhole",// &,;
endif

ifeq ($(CONFIG_PACKAGE_v2ray_$(BUILD_VARIANT)_without_dns_proxy),y)
V2RAY_SED_ARGS += \
	s,_ "github.com/v2fly/v2ray-core/proxy/dns",// &,;
endif

ifeq ($(CONFIG_PACKAGE_v2ray_$(BUILD_VARIANT)_without_dokodemo_proto),y)
V2RAY_SED_ARGS += \
	s,_ "github.com/v2fly/v2ray-core/proxy/dokodemo",// &,;
endif

ifeq ($(CONFIG_PACKAGE_v2ray_$(BUILD_VARIANT)_without_freedom_proto),y)
V2RAY_SED_ARGS += \
	s,_ "github.com/v2fly/v2ray-core/proxy/freedom",// &,;
endif

ifeq ($(CONFIG_PACKAGE_v2ray_$(BUILD_VARIANT)_without_mtproto_proxy),y)
V2RAY_SED_ARGS += \
	s,_ "github.com/v2fly/v2ray-core/proxy/mtproto",// &,;
endif

ifeq ($(CONFIG_PACKAGE_v2ray_$(BUILD_VARIANT)_without_http_proto),y)
V2RAY_SED_ARGS += \
	s,_ "github.com/v2fly/v2ray-core/proxy/http",// &,;
endif

ifeq ($(CONFIG_PACKAGE_v2ray_$(BUILD_VARIANT)_without_shadowsocks_proto),y)
V2RAY_SED_ARGS += \
	s,_ "github.com/v2fly/v2ray-core/proxy/shadowsocks",// &,;
endif

ifeq ($(CONFIG_PACKAGE_v2ray_$(BUILD_VARIANT)_without_socks_proto),y)
V2RAY_SED_ARGS += \
	s,_ "github.com/v2fly/v2ray-core/proxy/socks",// &,;
endif

ifeq ($(CONFIG_PACKAGE_v2ray_$(BUILD_VARIANT)_without_trojan_proto),y)
V2RAY_SED_ARGS += \
	s,_ "github.com/v2fly/v2ray-core/proxy/trojan",// &,;
endif

ifeq ($(CONFIG_PACKAGE_v2ray_$(BUILD_VARIANT)_without_vmess_proto),y)
V2RAY_SED_ARGS += \
	s,_ "github.com/v2fly/v2ray-core/proxy/vmess/inbound",// &,; \
	s,_ "github.com/v2fly/v2ray-core/proxy/vmess/outbound",// &,;
endif

ifeq ($(CONFIG_PACKAGE_v2ray_$(BUILD_VARIANT)_without_tcp_trans),y)
V2RAY_SED_ARGS += \
	s,_ "github.com/v2fly/v2ray-core/transport/internet/tcp",// &,;
endif

ifeq ($(CONFIG_PACKAGE_v2ray_$(BUILD_VARIANT)_without_mkcp_trans),y)
V2RAY_SED_ARGS += \
	s,_ "github.com/v2fly/v2ray-core/transport/internet/kcp",// &,;
endif

ifeq ($(CONFIG_PACKAGE_v2ray_$(BUILD_VARIANT)_without_websocket_trans),y)
V2RAY_SED_ARGS += \
	s,_ "github.com/v2fly/v2ray-core/transport/internet/websocket",// &,;
endif

ifeq ($(CONFIG_PACKAGE_v2ray_$(BUILD_VARIANT)_without_http2_trans),y)
V2RAY_SED_ARGS += \
	s,_ "github.com/v2fly/v2ray-core/transport/internet/http",// &,; \
	s,_ "github.com/v2fly/v2ray-core/transport/internet/headers/http",// &,;
endif

ifeq ($(CONFIG_PACKAGE_v2ray_$(BUILD_VARIANT)_without_domain_socket_trans),y)
V2RAY_SED_ARGS += \
	s,_ "github.com/v2fly/v2ray-core/transport/internet/domainsocket",// &,;
endif

ifeq ($(CONFIG_PACKAGE_v2ray_$(BUILD_VARIANT)_without_quic_trans),y)
V2RAY_SED_ARGS += \
	s,_ "github.com/v2fly/v2ray-core/transport/internet/quic",// &,;
endif

ifeq ($(CONFIG_PACKAGE_v2ray_$(BUILD_VARIANT)_without_mkcp_trans)$(CONFIG_PACKAGE_v2ray_$(BUILD_VARIANT)_without_quic_trans),yy)
V2RAY_SED_ARGS += \
	s,_ "github.com/v2fly/v2ray-core/transport/internet/headers/noop",// &,; \
	s,_ "github.com/v2fly/v2ray-core/transport/internet/headers/srtp",// &,; \
	s,_ "github.com/v2fly/v2ray-core/transport/internet/headers/tls",// &,; \
	s,_ "github.com/v2fly/v2ray-core/transport/internet/headers/utp",// &,; \
	s,_ "github.com/v2fly/v2ray-core/transport/internet/headers/wechat",// &,; \
	s,_ "github.com/v2fly/v2ray-core/transport/internet/headers/wireguard",// &,;
endif
...
define Build/Compile
	$(eval GO_PKG_BUILD_PKG:=github.com/v2fly/v2ray-core/main)
...
ifneq ($(CONFIG_PACKAGE_v2ray_$(BUILD_VARIANT)_exclude_v2ctl),y)
	$(eval GO_PKG_BUILD_PKG:=github.com/v2fly/v2ray-core/infra/control/main)
	$(call GoPackage/Build/Compile)
